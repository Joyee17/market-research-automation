...
**对外（求职加分项）**：
- Python + Node.js 双语言实现，展示开发能力
- 集成 Anthropic API + 网络搜索 + 文档生成，展示AI应用能力
- McKinsey级别分析框架，展示市场分析能力
- 六型框架完整覆盖，展示业务理解深度

**建议展示方式**：
1. GitHub上传代码（public仓库），README用英文写简洁版
2. 运行截图 + 生成的样例报告（脱敏后）
3. 在简历「项目经历」中描述：
   > 「独立开发市场调研自动化工具，集成Claude API + 网络搜索 + 自动生成Word/PPT，将传统1-2周的调研周期压缩至1-2天，支持McKinsey六型市场调研框架，数据来源涵盖World Bank、IEA、BloombergNEF等L1/L2级权威机构」

**对内（工作汇报展示）**：
1. 展示生成的完整报告，说明数据来源的权威性
2. 对比传统手工调研的时间成本
3. 说明如何保证数据质量（权威来源分级体系）

---

*README版本：v1.0 | 工具版本：v1.0 | 最后更新：2025年*
